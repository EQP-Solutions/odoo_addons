...
class ProductCertificateReport(models.Model):
    ...
    certificate_id = fields.Many2one(
        "product.certificate", string="Certificate", readonly=True
    )
    ...
    stage_id = fields.Many2one(
        "product.certificate.stage", string="Stage", readonly=True
    )
    ...
    _depends = {
        ...
        "res.company": [
            "product_certificate_days_to_red",
            "product_certificate_days_to_yellow",
        ],
    ...
    def _where(self):
        ...
        """.format(
            company_id=self.env.company.ids[0]
        )
